...
export const userListOrdersReducer = (state = {orders:[]}, action) => {
    switch (action.type) {
        case USER_LIST_ORDERS_REQUEST: return {loading: true}
        case USER_LIST_ORDERS_SUCCESS: return {loading: false, orders: action.payload}
        case USER_LIST_ORDERS_FAIL: return {loading: false, error: action.payload}
        case USER_LIST_ORDERS_RESET: return {orders: []}
        default: return state
    }
}